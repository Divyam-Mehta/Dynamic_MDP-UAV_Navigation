...
def Predict_Next_Bird_State(old_bird_loc, old_bird_vel):
    ...
    for bd in range(Bird_num):
        ...
        predicted_z = random.uniform(old_bird_loc[bd][2] - loc_obs_error, old_bird_loc[bd][2] + loc_obs_error) - random.uniform(old_bird_vel[bd][2] - vel_obs_error, old_bird_vel[bd][2] + vel_obs_error)
